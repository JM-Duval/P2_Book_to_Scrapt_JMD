# -*-coding: utf-8 -*
""" This program is a beta version of a script to automate a price monitoring system on a website.
The target is to retrieve information from each book and write it to a CSV file. And more, this
script download the picture of the plate book for each book.
"""
